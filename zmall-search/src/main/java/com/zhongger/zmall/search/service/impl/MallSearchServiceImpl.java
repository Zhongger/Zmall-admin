...
import com.zhongger.zmall.search.feign.ProductFeignService;
import com.zhongger.zmall.search.service.MallSearchService;
import com.zhongger.zmall.search.vo.AttrResponseVo;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    public SearchResult getSearchResult(SearchParam searchParam) {
        ...
        try {
            SearchResponse searchResponse = restHighLevelClient.search(request, ZmallElasticSearchConfig.COMMON_OPTIONS);
