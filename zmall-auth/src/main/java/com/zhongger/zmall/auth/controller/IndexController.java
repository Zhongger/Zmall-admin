package com.zhongger.zmall.auth.controller;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.TypeReference;
import com.zhongger.zmail.common.constant.AuthServerConstant;
import com.zhongger.zmail.common.exception.BizCodeEnume;
import com.zhongger.zmail.common.utils.R;
import com.zhongger.zmail.common.vo.MemberResponseVo;
import com.zhongger.zmall.auth.feign.MemberFeignService;
import com.zhongger.zmall.auth.feign.ThirdPartFeignService;
...
//    }
    ...
    public String loginPage(HttpSession session) {
        if (session.getAttribute(AuthServerConstant.LOGIN_USER) != null) {
            return "redirect:http://zmall.com:10000/";
        }else {
            return "login";
        }
    }
    ...
    public String login(UserLoginVo vo, RedirectAttributes attributes, HttpSession session){
        ...
        if (r.getCode() == 0) {
            ...
            return "redirect:http://auth.zmall.com:20000/login.html";
        }
    }
    ...
    public String register(@Valid UserRegisterVo registerVo, BindingResult result, RedirectAttributes attributes) {
        ...
        if (result.hasErrors()){
            ...
            //1.2 重定向到注册页
            return "redirect:http://auth.zmall.com:20000/register.html";
        }else {
            //2.若JSR303校验通过
            //判断验证码是否正确
